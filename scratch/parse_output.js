const fs = require('fs');
const data = JSON.parse(fs.readFileSync('/Users/zora/.gemini/antigravity-ide/brain/2cdd7d6b-7657-4b9b-905a-925011ae777c/.system_generated/steps/381/output.txt', 'utf8'));
